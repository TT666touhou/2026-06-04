...
##  20/21  SOP state check (docs/sop-state.md PENDING items)
##  21/21  GUT tests without addon (GAP-014) - tests/.gdignore required when addons/gut/ absent
...
## ============================================================
Write-Host "`n[20/21] Checking SOP state (docs/sop-state.md)..." -ForegroundColor Yellow
...
## ============================================================
## 21/21  GUT 測試 Addon 缺失偵測（GAP-014）
##        tests/ 有 extends GutTest 但 addons/gut/ 不存在 → WARN
##        若同時缺少 tests/.gdignore → 升為 FAIL（Godot 啟動即 Parse Error）
## ============================================================
Write-Host "`n[21/21] Checking GUT tests vs addon presence (GAP-014)..." -ForegroundColor Yellow
