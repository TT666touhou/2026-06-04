...
var PatrolStateClass = preload("res://scripts/enemy/enemy3/enemy3_patrol_state.gd")
var NoticeStateClass = preload("res://scripts/enemy/enemy3/enemy3_notice_state.gd")
var ShootStateClass = preload("res://scripts/enemy/enemy3/enemy3_shoot_state.gd")
