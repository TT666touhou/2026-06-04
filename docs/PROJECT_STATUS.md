...
| 3.1 | 房間系統（房間類型定義）| ⚠️ PARTIAL | 2026-06-12 |
| 3.2 | 關卡生成器（DungeonGenerator）| ✅ DONE | 2026-06-12 |
| 3.3 | 房間轉場（RoomTransition）| ⚠️ PARTIAL | 2026-06-12 |
| — | 敵人系統（基礎 HP + 死亡）| ⚠️ PARTIAL | 2026-06-12 |
| — | 房間實際場景（test_room_a/b）| ⚠️ PARTIAL | 2026-06-12 |
| — | Boss 房間場景 | ❌ TODO | — |
| — | 休息房間場景 | ❌ TODO | — |
